                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-custom btn-success text-white me-0" data-toggle="modal" data-target="#detalleModal" onclick="details({{$worker->id}})">
                                        <span class="fas fa-info-circle"></span> Detalles
                                    </button>
                                    <button class="btn btn-custom btn-danger text-white me-0" data-toggle="modal" data-target="#deleteModal" onclick="eliminar({{$worker->id}})">
