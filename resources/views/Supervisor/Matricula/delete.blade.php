...
<div class="modal fade" id="eliminarModal" tabindex="-1" role="dialog" aria-labelledby="detalleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{route('matricula.eliminaruser')}}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="detalleModalLabel">Eliminar Trabajador</h5>
                ...
                <div class="modal-footer">
                    <input type="hidden" id="worker_id_eliminar" name="worker_id" value="">
