    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modalContent">
                ...
                <p><strong>Empresa:</strong> <span id="nombre_detalle"></span></p>
                <p><strong>Descripción:</strong> <span id="descripcion_detalle"></span></p>
                <p><strong>RUC:</strong> <span id="ruc_detalle"></span></p>
                <hr>
