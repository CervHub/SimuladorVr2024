            ...
            <td>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            <td
                                style="width: 10px; border-left: 1px solid transparent; border-top: 1px solid transparent;">
                            </td>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td class="text-center" colspan="3" style="width: 150px;">Valoración de Riesgo
                                    Real</td>
                            </tr>
                            <tr>
