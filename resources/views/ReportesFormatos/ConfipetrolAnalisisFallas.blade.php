...
<html lang="en"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    } .texto-white { color: white !important; } .bg-red{ background-color: red;} .bg-yellow{ background-color: yellow;}
    .bg-green{ background-color: green;} .bg-orange{ background-color: orange;}</style> <link rel="stylesheet"
    type="text/css" href="estilos.css">
</head> <body> <!-- Logo en la esquina superior izquierda --> <table class="table"> <tbody> <tr> <th rowspan="2"
    style="width:60px !important;"> <img src="{{$logo}}" width="64px" alt="Logo">
</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" style="vertical-align: middle !important;">
                    FINALIZADO: <input type="checkbox" name="finalizado" value="si"> SI
                    <input type="checkbox" name="finalizado" value="no"> NO
                </td>
            </tr>
        </tbody>
</table>
    ...
    <tr>
        <td>
            ...
            <table class="table">
                <tbody>
                    <tr>
                        <td style="width: 10px; border-left: 1px solid transparent; border-top: 1px solid transparent;">
                        </td>
                        <td colspan="5" class="texto-bold text-center">Severidad</td>
                        <td colspan="5" class="texto-bold text-center">Frecuencia ocurrencia</td>
                    </tr>
                    <tr>
                        <td class="text-center texto-bold" style="width: 10px;">No.</td>
                        <td class="text-center texto-bold" style="width: 50px;">Personas</ texto-boldtd>
                        <td class="text-center texto-bold" style="width: 50px;">Económica</td>
                        <td class="text-center texto-bold" style="width: 50px;">Ambiental</td>
                        <td class="text-center texto-bold" style="width: 50px;">Pérdidas de Producción</td>
                        <td class="text-center texto-bold" style="width: 50px;">Imagen de la empresa</td>
                        <td class="text-center texto-bold" style="width: 50px;">1 Vez cada 5 años o más</td>
                        <td class="text-center texto-bold" style="width: 50px;">1 Vez cada 3 años</td>
                        <td class="text-center texto-bold" style="width: 50px;">1 Vez al Año</td>
                        <td class="text-center texto-bold" style="width: 50px;">1 Vez cada 3 meses</td>
                        <td class="text-center texto-bold" style="width: 50px;">1 Vez al mes</td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center bg-yellow" style="width: 50px;">Media</td>
                        <td class="text-center bg-yellow" style="width: 50px;">Media</td>
                        <td class="text-center bg-orange" style="width: 50px;">Alta</td>
                        <td class="text-center bg-orange" style="width: 50px;">Alta</td>
                        <td class="text-center bg-red" style="width: 50px;">Muy Alta</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center bg-green" style="width: 50px;">Nula</td>
                        <td class="text-center" style="width: 50px;">Baja</td>
                        <td class="text-center" style="width: 50px;">Baja</td>
                        <td class="text-center" style="width: 50px;">Baja</td>
                        <td class="text-center bg-yellow" style="width: 50px;">Media</td>
                    ...
                    <tr>
                        <td colspan="6"
                            style="border-left: 1px solid transparent; border-bottom: 1px solid transparent;"></td>
